...
const Singleproduct = () => {
    const obj = useParams()
     ...
     useEffect(()=>{
        fetch(`https://mock-server-app2-dll0.onrender.com/product/${obj.id}`)
        .then((Res)=>Res.json())
        .then((res)=>{
         setData(res)
        })
  ...
  return (
    ...
    <div id="Div_container">
        ...
        <div id="Div_1">   
            <div id="Div_2">
            <img id="Div_2_img" src={data.image1} />
            </div>
            <div id="Div_3">
             <div id="Div_4"><p id="Div4_p1">{data.card_title}</p></div>
             <div id="Div_5">
    ...
    <div id="Div_12">
        ...
        <p id="DESCO" className='d12pp'>{data.description}</p></div>
