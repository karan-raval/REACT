                  ...
                  <div className="white_card_body">
                    <div id="marketchart">
                      <div
                        ...
                        class="apexcharts-canvas apexchartsbo8g3kco light hh"
                      >
                        <svg
                          id="SvgjsSvg2025"
                          width="617"
                            ...
                            >
                              ...
                              >
                                <text
                                  ...
                                  font-weight="400"
                                  fill="#373d3f"
                                  class="apexcharts-xaxis-label fm"
                                >
                          ...
                          >
                            <g id="SvgjsG2070" class="apexcharts-yaxis-texts-g">
                              <text
                                ...
                                font-weight="regular"
                                fill="#373d3f"
                                class="apexcharts-yaxis-label fm"
                              >
                                120
                              </text>
                              <text
                        ...
                        <div class="apexcharts-tooltip light le">
                          <div class="apexcharts-tooltip-title">Apr</div>
                          <div class="apexcharts-tooltip-series-group active df">
                            <span class="apexcharts-tooltip-marker bgc"></span>
                            <div class="apexcharts-tooltip-text fs">
                          ...
                          <div class="apexcharts-tooltip-series-group dn">
                            <span class="apexcharts-tooltip-marker bgc"></span>
                            <div class="apexcharts-tooltip-text fs">
                              <div class="apexcharts-tooltip-y-group">
                                <span class="apexcharts-tooltip-text-label">
                  ...
                  <div className="white_card_body">
                    <div id="chart-currently">
                      <div
                        ...
                        class="apexcharts-canvas apexchartss6rob4r2 light hw"
                      >
                        <svg
                          id="SvgjsSvg3184"
                          width="267"
                        ...
                        <div class="apexcharts-tooltip light">
                          <div class="apexcharts-tooltip-title fs"></div>
                          <div class="apexcharts-tooltip-series-group">
                            <span class="apexcharts-tooltip-marker colo"></span>
                            <div class="apexcharts-tooltip-text fs">
                              <div class="apexcharts-tooltip-y-group">
                        ...
                        <div class="apexcharts-xaxistooltip apexcharts-xaxistooltip-bottom light">
                          <div class="apexcharts-xaxistooltip-text fs"></div>
                        </div>
                      </div>
                    </div>
              ...
              <div className="col-xl-7">
                <div className="white_card card_height_100  mb_20">
                  ...
                  <div className="white_card_body">
                    ...
                    >
                      <div id="world-map-markers" class="dashboard_w_map pb_20">
                        <div
                          class="jvectormap-container bgtrans"
