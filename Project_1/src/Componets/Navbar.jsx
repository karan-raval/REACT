                ...
                <div className="div_3">
                    <ul>
                        <li className="threeDots">
                            <span className="material-symbols-outlined md18">density_medium</span>
