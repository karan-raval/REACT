    ...
    <>
      ...
      <div id="GK_PARENT">
        <div id="Div_container">
          <p id="PPKT" className="ppp">
            Home - Hair - Shop By Hair Type - {data[0].category}
          </p>
          <div id="Div_1">
            <div id="Div_2">
            ...
            <div id="Div_3">
              ...
              <div id="Div_6">
                <div id="Div_7">
                  <p>MRP:</p>
                  <p id="Div7_p1" className="d7p1">
                    ₹{data[0].price}
                  </p>
                  <p id="Div7_p2" className="d7p2">
                    ₹{data[0].off_price}
                  </p>
                  <p id="Div7_p3" className="d7p3">
                    {data[0].offer}% Off
                  </p>
                </div>
              ...
              <div id="Div_8">
                <button className="Div8_b1" onClick={handleclick}>
                  Add to Bag
                </button>
                <div id="Div_9">
