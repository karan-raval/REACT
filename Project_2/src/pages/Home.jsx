                  ...
                  <div className="white_card_body">
                    <div id="marketchart">
                      <div
                        ...
                        className="apexcharts-canvas apexchartsbo8g3kco light hh"
                      >
                        <svg
                          id="SvgjsSvg2025"
                          width="617"
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <text
                                  ...
                                  fontWeight="400"
                                  fill="#373d3f"
                                  className="apexcharts-xaxis-label fm"
                                >
                                  <tspan id="SvgjsTspan2058" className="fm">
                                    Feb
                                  </tspan>
                                  <title>Feb</title>
                                </text>
                                <text
                                  ...
                                  className="apexcharts-xaxis-label fm"
                                >
                                  <tspan id="SvgjsTspan2060" className="fm">
                                    Mar
                                  </tspan>
                                  <title>Mar</title>
                                </text>
                                <text
                                  ...
                                  className="apexcharts-xaxis-label fm"
                                >
                                  <tspan id="SvgjsTspan2062" className="fm">
                                    Apr
                                  </tspan>
                                  <title>Apr</title>
                                </text>
                                <text
                                  ...
                                  className="apexcharts-xaxis-label fm"
                                >
                                  <tspan id="SvgjsTspan2064" className="fm">
                                    May
                                  </tspan>
                                  <title>May</title>
                                </text>
                                <text
                                  ...
                                  className="apexcharts-xaxis-label fm"
                                >
                                  <tspan id="SvgjsTspan2066" className="fm">
                                    Jun
                                  </tspan>
                                  <title>Jun</title>
                                </text>
                                <text
                                  ...
                                  className="apexcharts-xaxis-label fm"
                                >
                                  <tspan id="SvgjsTspan2068" className="fm">
                                    Jul
                                  </tspan>
                                  <title>Jul</title>
                                </text>
                            ...
                            <g id="SvgjsG2076" className="apexcharts-grid">
                              <g
                                id="SvgjsG2077"
                            ...
                            >
                              ...
                              >
                                <path
                                  ...
                                  index="0"
                                  clipPath="url(#gridRectMaskbo8g3kco)"
                          ...
                          >
                            ...
                            >
                              <text
                                ...
                                fontWeight="regular"
                                fill="#373d3f"
                                className="apexcharts-yaxis-label fm"
                              >
                                120
                              </text>
                              <text
                        ...
                        <div className="apexcharts-tooltip light le">
                          <div className="apexcharts-tooltip-title">Apr</div>
                          <div className="apexcharts-tooltip-series-group active df">
                            <span className="apexcharts-tooltip-marker bgc"></span>
                            <div className="apexcharts-tooltip-text fs">
                          ...
                          <div className="apexcharts-tooltip-series-group dn">
                            <span className="apexcharts-tooltip-marker bgc"></span>
                            <div className="apexcharts-tooltip-text fs">
                              <div className="apexcharts-tooltip-y-group">
                                <span className="apexcharts-tooltip-text-label">
                  ...
                  <div className="white_card_body">
                    <div id="chart-currently">
                      <div
                        ...
                        className="apexcharts-canvas apexchartss6rob4r2 light hw"
                      >
                        <svg
                          id="SvgjsSvg3184"
                          width="267"
                        ...
                        >
                          ...
                          >
                            ...
                            <g id="SvgjsG3206" className="apexcharts-grid">
                              <line
                                id="SvgjsLine3208"
                                x1="0"
                                y1="80"
                            ...
                            >
                              ...
                              >
                                <path
                                  ...
                                  index="0"
                                  clipPath="url(#gridRectMasks6rob4r2)"
                                ...
                                >
                                  <g className="apexcharts-series-markers">
                                    <circle
                                      ...
                                      cx="0"
                                      cy="0"
                                      className="apexcharts-marker w201ka1agf no-pointer-events"
                                      stroke="#f65365"
                                      fill="#ffffff"
                                      fillOpacity="1"
                                      strokeWidth="3"
                        ...
                        <div className="apexcharts-tooltip light">
                          <div className="apexcharts-tooltip-title fs"></div>
                          <div className="apexcharts-tooltip-series-group">
                            <span className="apexcharts-tooltip-marker colo"></span>
                            <div className="apexcharts-tooltip-text fs">
                              <div className="apexcharts-tooltip-y-group">
                        ...
                        <div className="apexcharts-xaxistooltip apexcharts-xaxistooltip-bottom light">
                          <div className="apexcharts-xaxistooltip-text fs"></div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="white_card card_height_100 mb_30">
                  ...
                  <div className="white_card_body ">
                    <div className="card_container">
                      <div
                        id="platform_type_dates_donut my"
                        _echarts_instance_="ec_1727418368424"
                      >
                        <div className="my1">
                          <canvas
                            data-zr-dom-id="zr_0"
                        ...
                        <div className="jvectormap-container bgtrans">
                          <svg width="529.656" height="250">
                            ...
                            <g>
                              <circle
                                data-index="0"
                                cx="112.39410370875824"
                                cy="106.3998146916887"
                                fill="#f93b7a"
                                stroke="#7474b126"
                                fillOpacity="1"
                                strokeWidth="1"
                                strokeOpacity="1"
                                r="5"
                                className="jvectormap-marker jvectormap-element"
                              ></circle>
                              <circle
                                data-index="1"
                                cx="301.78900198450276"
                                cy="72.93934585161269"
                                fill="#0aafff"
                                stroke="#7474b126"
                                fillOpacity="1"
                                strokeWidth="1"
                              ...
                              <circle
                                data-index="2"
                                cx="423.21264749331976"
                                cy="193.2806037889051"
                                fill="#7551e9"
                                stroke="#7474b126"
                                fillOpacity="1"
                                strokeWidth="1"
                              ...
                              <circle
                                data-index="3"
                                cx="189.71274576598742"
                                cy="177.88773613308294"
                                fill="#ffc212"
                                stroke="#7474b126"
                                fillOpacity="1"
                                strokeWidth="1"
