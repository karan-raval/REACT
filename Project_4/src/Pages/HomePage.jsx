                ...
                <div className="featured">
                    ...
                    <div className="featured__column featured__column--big">
                        <div className="entry bg1" >
                            ...
                            <div className="entry__content">
                                <span className="entry__category"><a  >Music</a></span>
                    ...
                    <div className="featured__column featured__column--small">
                        ...
                        <div className="entry bg2" >
                            ...
                            <div className="entry__content">
                                <span className="entry__category"><a  >Management</a></span>
                        ...
                        <div className="entry bg3" >
                            ...
                            <div className="entry__content">
                                <span className="entry__category"><a  >LifeStyle</a></span>
    ...
    <section className="s-content">
        ...
        <div className="row">
            <div className="col-full">
                <nav className="pgn">
                    <ul>
                        <li><a className="pgn__prev"  >Prev</a></li>
                        <li><a className="pgn__num"  >1</a></li>
                        <li><span className="pgn__num current">2</span></li>
                        <li><a className="pgn__num"  >3</a></li>
                        <li><a className="pgn__num"  >4</a></li>
                        <li><a className="pgn__num"  >5</a></li>
                        <li><span className="pgn__num dots">…</span></li>
                        <li><a className="pgn__num"  >8</a></li>
                        <li><a className="pgn__next"  >Next</a></li>
                    </ul>
                </nav>
            </div>
        </div>
            ...
            <div className="col-eight md-six tab-full popular">
                ...
                <div className="block-1-2 block-m-full popular__posts">
                    <article className="col-block popular__post">
                        ...
                        <h5><a  >Visiting Theme Parks Improves Your Health.</a></h5>
                        <section className="popular__meta">
                                <span className="popular__author"><span>By</span> <a  > John Doe</a></span>
                    ...
                    <article className="col-block popular__post">
                        ...
                        <h5><a  >Key Benefits Of Family Photography.</a></h5>
                        <section className="popular__meta">
                            <span className="popular__author"><span>By</span> <a  > John Doe</a></span>
                    ...
                    <article className="col-block popular__post">
                        ...
                        <h5><a  >Absolutely No Sugar Oatmeal Cookies.</a></h5>
                        <section className="popular__meta">
                                <span className="popular__author"><span>By</span> <a  > John Doe</a></span>
                    ...
                    <article className="col-block popular__post">
                        ...
                        <h5><a  >Throwback To The Good Old Days.</a></h5>
                        <section className="popular__meta">
                            <span className="popular__author"><span>By</span> <a  > John Doe</a></span>
                            <span className="popular__date"><span>on</span> <time datetime="2017-12-16">Dec 16, 2017</time></span>
                        </section>
                    ...
                    <article className="col-block popular__post">
                        ...
                        <h5><a  >10 Interesting Facts About Caffeine.</a></h5>
                        <section className="popular__meta">
                            <span className="popular__author"><span>By</span> <a  > John Doe</a></span>
                    ...
                    <article className="col-block popular__post">
                        ...
                        <h5><a  >Healthy Mediterranean Salad Recipes</a></h5>
                        <section className="popular__meta">
                            <span className="popular__author"><span>By</span> <a  > John Doe</a></span>
